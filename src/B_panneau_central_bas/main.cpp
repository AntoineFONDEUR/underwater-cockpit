...
Panel myPanel {
  {
    ...
    new AxisInput("joystick_left_h", Pin{1, ADS2}, 1, DEAD_ZONE, false,32, 29000),
    new AxisInput("joystick_left_v", Pin{2, ADS2}, 2, DEAD_ZONE, false,32, 29000, true),
    new AxisInput("joystick_left_tilt", Pin{0, ADS2}, 3, DEAD_ZONE, false,32, 29000, true),
